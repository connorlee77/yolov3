...
class LoadImagesAndLabels(Dataset):  # for training/testing
    ...
    def __getitem__(self, index):
        ...
        present_classes = set(labels_out[:,1].int().numpy())
        multilabel = torch.zeros(80)
        multilabel[list(present_classes)] = 1

        return torch.from_numpy(img), multilabel, self.img_files[index], shapes
